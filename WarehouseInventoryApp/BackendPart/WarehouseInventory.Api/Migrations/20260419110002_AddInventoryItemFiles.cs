...
{
    /// <inheritdoc />
    public partial class AddInventoryItemFiles : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "InventoryItemFiles",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InventoryItemFiles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InventoryItemFiles_InventoryItems_InventoryItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryItemFiles_InventoryItemId",
                table: "InventoryItemFiles",
